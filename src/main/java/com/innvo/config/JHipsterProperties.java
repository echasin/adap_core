...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_core@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_core API";

        private String description = "adap_core API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_core";
