...
public class Assetassetmbr implements Serializable {
    ...
    public Asset getAssetparent() {
        return assetparent;
    }

    public void setAssetparent(Asset asset) {
        this.assetparent = asset;
    }

    public Asset getAssetchild() {
        return assetchild;
    }

    public void setAssetchild(Asset asset) {
