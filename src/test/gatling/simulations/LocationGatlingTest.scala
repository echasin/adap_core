...
class LocationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Location entity")
        ...
        .repeat(2) {
            ...
            .post("/api/locations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "recordtype":"SAMPLE_TEXT", "addressline1":"SAMPLE_TEXT", "addressline2":"SAMPLE_TEXT", "statecode":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "lastmodifiedby":"SAMPLE_TEXT", "lastmodifieddatetime":"2020-01-01T00:00:00.000Z", "domain":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
