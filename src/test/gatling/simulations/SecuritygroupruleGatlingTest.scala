...
/**
 * Performance test for the Securitygrouprule entity.
 */
class SecuritygroupruleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Securitygrouprule entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all securitygrouprules")
            .get("/api/securitygrouprules")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created securitygrouprule")
                .get("${new_securitygrouprule_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created securitygrouprule")
            .delete("${new_securitygrouprule_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
